...
function App() {
  return (
    <div>
      ...
      <ParallaxLayer offset={2} factor={4.5} style={{background:'#e0e1dd'}}>
      <MyJourney/>
      </ParallaxLayer>
      <ParallaxLayer offset={6.5} factor={1.5} style={{background:'#0D1B2A'}}>
      <h1 className='projects-title'>Projects</h1>
      <Projects/>
      </ParallaxLayer>
      <ParallaxLayer offset={8} factor={1}style={{background:'#e0e1dd'}}>
        <h1 className='gallery-title'>My Gallery</h1>
        <GalleryRevamped/>
      </ParallaxLayer>
      <ParallaxLayer offset={9} factor={0.18} style={{background:'#0D1B2A'}}>
      <Footer/>
      </ParallaxLayer>
