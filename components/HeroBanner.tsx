...
import Logo from './Logo'; // Assuming your Logo component is in a file named Logo.js
...
const pagesContent = [
  { background: '#1B263B', text: 'Luthira Abeykoon', subtitle: 'Telekinesis' },
  { background: '#778da9', text: 'Luthira Abeykoon', subtitle: 'Coding' },
  { background: '#415a77', text: 'Luthira Abeykoon', subtitle: 'Photograhy' },
];
